...
def main():
    ...
    noisy_controller = NoisyController() #create an instace of the NoisyController class
    rclpy.spin(noisy_controller) #this will run continuously the simple_controller object 
    
    noisy_controller.destroy_node() #if the execution of the node is done, then we have to distroy the node 
