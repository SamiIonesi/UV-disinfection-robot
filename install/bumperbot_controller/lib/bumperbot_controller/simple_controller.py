...
def main():
    ...
    simple_controller = SimpleController() #create an instace of the SimpleController class
    rclpy.spin(simple_controller) #this will run continuously the simple_controller object 
    
    simple_controller.destroy_node() #if the execution of the node is done, then we have to distroy the node 
    rclpy.shutdown() #and also we have to shud down the ros2 interface
